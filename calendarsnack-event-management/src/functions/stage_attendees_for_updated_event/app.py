...
def process_request_from(record):
    ...
    queue_updated_event_for_processing(
...
def queue_updated_event_for_processing(event, attendees):
    """Queue event update for processing."""
    for attendee in attendees:
        ...
        aws.publish_sns_message(
            ...
            arn=os.environ["EVENT_UPDATE_REQUEST"],
            sns=sns,
        )
